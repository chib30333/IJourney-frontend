                ...
                <div className="space-y-6">
                    <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-500">
                        ...
                        <div className="bg-white p-6 rounded-lg shadow mb-6">
                            ...
                            <div className="mb-4">
                                <p className="text-sm">{smartGoals[0].goal || "Your goal description will appear here..."}</p>
                            </div>
                        ...
                        <div className="bg-white p-6 rounded-lg shadow mb-6">
                            <div className="flex items-center justify-between mb-4">
                                <h5 className="font-semibold text-green-700">SMART Goal #2</h5>
                                <div className="flex items-center gap-2">
                                    <Target className="w-5 h-5 text-green-600" />
                                    <span className="text-sm">Specific</span>
                                </div>
                            ...
                            <div className="mb-4">
                                <p className="text-sm">{smartGoals[1].goal || "Your goal description will appear here..."}</p>
                            </div>
                            ...
                            <div className="mb-4">
                                <p className="text-sm">{smartGoals[1].accountabilityPartner || "Your accountability partner name will appear here..."}</p>
                            </div>
                            ...
                            <div className="mb-4">
                                <p className="text-sm">{smartGoals[1].deadline || "Your check-in method will appear here..."}</p>
                            </div>
                        </div>

                        <div className="bg-white p-6 rounded-lg shadow">
                            <div className="flex items-center justify-between mb-4">
                                <h5 className="font-semibold text-green-700">SMART Goal #3</h5>
                                <div className="flex items-center gap-2">
                                    <Target className="w-5 h-5 text-green-600" />
                                    <span className="text-sm">Specific</span>
                                </div>
                            ...
                            <div className="mb-4">
                                <p className="text-sm">{smartGoals[2].goal || "Your goal description will appear here..."}</p>
                            </div>
                            ...
                            <div className="mb-4">
                                <p className="text-sm">{smartGoals[2].accountabilityPartner || "Your accountability partner name will appear here..."}</p>
                            </div>
                            ...
                            <div className="mb-4">
                                <p className="text-sm">{smartGoals[2].deadline || "Your check-in method will appear here..."}</p>
                            </div>
                        </div>
                    </div>
