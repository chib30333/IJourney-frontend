...
function InvestingEducation() {
    ...
    const next = async () => {
        if (user) {
            try {
                const result = await unlockNext({ userId: user?.uid, milestoneId: "milestone5/4" });
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-500">
                        ...
                        <div className="mt-4 space-y-2">
                            <a href="https://www.scholarshiptoolbox.sc.gov/" target="_blank" rel="noopener noreferrer" className="inline-block underline text-[14px] font-bold">
