...
function ResourceInventory() {
    ...
    const [customResource2, setCustomResource2] = useState('');
    ...
    const next = async () => {
        ...
        if (customResource1.trim()) finalResources.push(`custom1:${customResource1}`);
        if (customResource2.trim()) finalResources.push(`custom2:${customResource2}`);
                ...
                <div className="bg-white rounded-xl shadow-2xl p-6 mt-8">
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <input
                                type="text"
                                value={customResource1}
                                onChange={(e) => setCustomResource1(e.target.value)}
                        ...
                        <div>
                            ...
                            <input
                                type="text"
                                value={customResource2}
                                onChange={(e) => setCustomResource2(e.target.value)}
                                placeholder="e.g., Professional association, community organization, etc."
                                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                            />
                        </div>
                    </div>
